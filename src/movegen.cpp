...
ExtMove* generate_moves(const Position& pos, ExtMove* moveList) {
    ...
    // Precompute shared values used across all piece types
    const Bitboard occupied = pos.pieces();
    const Bitboard our_pieces = pos.pieces(us);
    const Bitboard target_captures = pos.pieces(them) & ~pos.pieces(them, KING);
    ...
    while (pawns) {
        ...
        Bitboard targets = target_captures | ep_bb;
    ...
    while (knights) {
        ...
        Bitboard kn_attacks = knight_attacks_bb(from);
        Bitboard attacks = kn_attacks & target_captures;
        Bitboard quiets = kn_attacks & ~occupied;
    ...
    while (bishops) {
        ...
        Bitboard attacks = all_attacks & target_captures;
        Bitboard quiets = all_attacks & ~occupied;
    ...
    // King
    Bitboard king_att = king_attacks_bb(ksq);
    Bitboard king_captures = king_att & target_captures;
    Bitboard king_quiets = king_att & ~occupied;
