// Generated from LeelaChessZero/lc0 src/neural/encoder.cc kMoveStrs (policy-index order).
// Each entry: from(2) to(2) [promo(1)]. Index in this array == policy/NN index.
static const char* kNNMoves[1858] = {
