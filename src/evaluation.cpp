...
Value evaluate(const Position& pos, bool tactical_only) {
    ...
    // Phase: material phase for MG/EG interpolation (computed once, used for quick exit and final)
    ...
    // -------------------------------------------------------
    // Score interpolation (phase already computed above)
    // -------------------------------------------------------
