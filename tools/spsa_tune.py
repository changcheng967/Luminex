...
def get_default_params() -> List[SPSAParam]:
    return [
        SPSAParam("BishopPairMG",          40,    0,   80),
        SPSAParam("BishopPairEG",         100,   20,  180),
        SPSAParam("RookOpenMG",            25,    0,   60),
        SPSAParam("RookOpenEG",            40,   10,   90),
        SPSAParam("RookSemiOpenMG",        15,    0,   50),
        SPSAParam("RookSemiOpenEG",        20,    0,   40),
        SPSAParam("Rook7thMG",             30,    0,   60),
        SPSAParam("Rook7thEG",             25,    0,   50),
        SPSAParam("PawnShieldCenter",      12,    0,   30),
        SPSAParam("PawnShieldKnight",      15,    0,   40),
        SPSAParam("PawnShieldRook",         8,    0,   25),
        SPSAParam("PawnStorm",             10,    0,   25),
        SPSAParam("OpenFilePenaltyMG",     20,    0,   50),
        SPSAParam("OpenFilePenaltyEG",     15,    0,   50),
        SPSAParam("OutpostKnightMG",       30,    0,   70),
        SPSAParam("OutpostKnightEG",       15,    0,   50),
        SPSAParam("OutpostBishopMG",       40,   10,  100),
        SPSAParam("OutpostBishopEG",       25,    0,   70),
        SPSAParam("HangingPawnMG",         10,  -20,   40),
        SPSAParam("HangingPawnEG",         35,    0,   80),
        SPSAParam("FarKnightMG",           15,    0,   60),
        SPSAParam("FarKnightEG",            5,    0,   30),
        SPSAParam("FarBishopMG",           10,  -20,   30),
        SPSAParam("FarBishopEG",            5,  -10,   20),
    ]
